...
horizontal tiles: key(alt-shift-t)
vertical tiles: key(alt-shift-v)
horizontal accordion: key(alt-shift-a)
vertical accordion: key(alt-shift-s)
window max: key(alt-shift-f)
